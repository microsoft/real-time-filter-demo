...
namespace RealtimeFilterDemo.Resources {
    ...
    public class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This is an example application demonstrating the real-time use of effects provided by the Lumia Imaging SDK. The effects are applies to the stream of images received from the camera device..
        /// </summary>
